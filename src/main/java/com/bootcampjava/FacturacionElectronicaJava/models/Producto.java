...
public class Producto {
    ...
    @Column(name = "stockMinimo", nullable = false, precision = 18, scale = 4)
    private BigDecimal stockMinimo;

    @Column(name = "activo", nullable = false, precision = 18, scale = 4)
    private BigDecimal activo; // soft delete
...
// despues No Gravado, No Sijeto, Exento
